...
import com.android.example.musicplayer.R
import com.android.example.musicplayer.SongTimer
import com.android.example.musicplayer.SongsManager
...
class PlaySongActivity : AppCompatActivity(), OnSeekBarChangeListener, OnCompletionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val seekBar = SeekBar(applicationContext)
    ...
    fun getButtonSong() {
        ...
        val visualizerView = findViewById<AudioVisualizer>(R.id.visualizerView)
        ...
        val imagePrev = findViewById<ImageView>(R.id.imagePrev)
        ...
        val imageForward = findViewById<ImageView>(R.id.imageForward)
        ...
        val imageRewind = findViewById<ImageView>(R.id.imageRewind)
        ...
        val imageRepeat = findViewById<ImageView>(R.id.imageRepeat)
        val imageShuffle = findViewById<ImageView>(R.id.imageShuffle)
    ...
    val tvCurrentDuration = findViewById<TextView>(R.id.tvCurrentDuration)
