...
import com.musicplayeryusriizal.SongTimer
import com.musicplayeryusriizal.SongsManager
...
class PlaySongActivity : AppCompatActivity(), OnSeekBarChangeListener, OnCompletionListener {
    ...
    lateinit var tvCurrentDuration:TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvCurrentDuration = findViewById<TextView>(R.id.tvCurrentDuration)
        tvTotalDuration = findViewById<TextView>(R.id.tvTotalDuration)
